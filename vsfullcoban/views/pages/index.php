...
if ($search_keyword !== '') {
    ...
    // $categories được load từ header.php qua getAllCategories()
...
// Xử lý Phân trang AJAX: Nếu nhận được tham số ?ajax=1, ta sẽ bắt đầu ghi đệm đầu ra
...
?>
    <section class="container mx-auto px-4 mt-4 md:mt-6">
        <div class="grid grid-cols-1 gap-4">
            <!-- Banner chính (Full width sau khi bỏ AI Consult) -->
    ...
    <div class="w-full">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-100 pb-3">
            ...
            <?php else: ?>
                    ...
                    <?php foreach ($products as $p): 
                        ...
                        <div class="product-card p-3 flex flex-col relative cursor-pointer" onclick="viewProduct(<?= $productJson ?>)">
                            ...
                            <div class="absolute top-3 left-3 flex flex-col gap-1 z-10 items-start">
                                <?php if (strpos($p['gift_text'], 'Trả góp') !== false || in_array('Trả góp 0%', $tags)): ?><span
                ...
                <?php
                // Nếu là AJAX, ta kết thúc việc ghi đệm và trả về nội dung phần này
                if ($is_ajax) {
...
<script>
    ...
    function initAjaxPagination() {
        ...
        productSection.addEventListener('click', function(e) {
            const link = e.target.closest('.pagination-link, .pagination-nav-btn');
