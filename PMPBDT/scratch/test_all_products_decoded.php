...
$js = "const productsData = " . $json . ";\nconsole.log('Successfully parsed productsData with PHP array decoding!');\nconsole.log(productsData[0].more_images);";
file_put_contents('scratch/test_all_products_decoded.js', $js);
