...
// Tự động nạp biến môi trường từ .env nếu chưa được nạp
...
// ============================================================
define('SMTP_HOST', getenv('SMTP_HOST') ?: ($_ENV['SMTP_HOST'] ?? $_SERVER['SMTP_HOST'] ?? 'smtp.gmail.com'));
define('SMTP_PORT', (int) (getenv('SMTP_PORT') ?: ($_ENV['SMTP_PORT'] ?? $_SERVER['SMTP_PORT'] ?? 587)));
define('SMTP_USERNAME', getenv('SMTP_USERNAME') ?: ($_ENV['SMTP_USERNAME'] ?? $_SERVER['SMTP_USERNAME'] ?? ''));
define('SMTP_PASSWORD', getenv('SMTP_PASSWORD') ?: ($_ENV['SMTP_PASSWORD'] ?? $_SERVER['SMTP_PASSWORD'] ?? ''));
define('SMTP_FROM_NAME', getenv('SMTP_FROM_NAME') ?: ($_ENV['SMTP_FROM_NAME'] ?? $_SERVER['SMTP_FROM_NAME'] ?? 'DienMayPro'));
define('SMTP_FROM_EMAIL', getenv('SMTP_FROM_EMAIL') ?: ($_ENV['SMTP_FROM_EMAIL'] ?? $_SERVER['SMTP_FROM_EMAIL'] ?? SMTP_USERNAME));
