<?php
/**
 * API CHATBOT RAG (Retrieval-Augmented Generation) cho Mobile App & Web
 * PHP sẽ:
 * 1. Nhận câu hỏi
...
require_once __DIR__ . '/../../core/config_api.php'; // File chứa $GEMINI_API_KEY

header('Content-Type: application/json; charset=utf-8');

// Nhận dữ liệu POST từ JS/Mobile
...
// ----------------------------------------------------
$replyLangInstruction = "5. QUAN TRỌNG: Khách hàng hỏi bằng ngôn ngữ nào, bạn PHẢI trả lời hoàn toàn bằng ngôn ngữ đó.";
...
1. PHẢI TRẢ LỜI CHI TIẾT, GIÀU THÔNG TIN VÀ CÓ PHÂN TÍCH SÂU:
   - Hãy tư vấn một cách chi tiết và nhiệt tình cho khách hàng. Phân tích rõ các dòng sản phẩm, thương hiệu liên quan để khách hàng có sự lựa chọn phù hợp nhất.

2. QUY TẮC CHÈN LINK (KHÔNG ĐƯỢC ĐỂ HỎNG LINK):
   - Để chèn link xem chi tiết cho THƯƠNG HIỆU, DANH MỤC hoặc PHÂN LOẠI SẢN PHẨM: bạn PHẢI sử dụng link tìm kiếm tích hợp của hệ thống: <a href=\"index.php?search=từ_khóa\" class=\"text-blue-600 font-bold hover:underline\">tên_thương_hiệu/tên_danh_mục</a>.
...
5. QUY TẮC ĐỊNH DẠNG CÂU TRẢ LỜI:
   ...
   - Sắp xếp các phân loại bằng các emoji ở đầu dòng (ví dụ: 👉, ✅, 📱, 💻) để tạo bố cục thoáng đãng, chuyên nghiệp.
