...
<div class="container mx-auto px-4 py-8 max-w-5xl">
    ...
    <?php if ($order_success): ?>
        ...
        <div class="bg-white p-10 rounded-xl shadow-sm border border-gray-200 text-center max-w-2xl mx-auto mt-10">
            ...
            <a href="cart.php" class="bg-gray-100 text-gray-700 px-8 py-3 rounded-lg font-bold hover:bg-gray-200 transition shadow-md inline-block ml-2 border border-gray-200">Trở lại Giỏ hàng</a>
        </div>
