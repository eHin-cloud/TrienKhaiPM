    ...
    <?php else: ?>
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4">
            ...
            <div class="product-card p-3 flex flex-col relative cursor-pointer" onclick="viewProduct(<?= $productJson ?>)">
                ...
                <!-- NÚT MUA NGAY ĐƯỢC TÍCH HỢP AJAX -->
                <div class="mt-3 grid grid-cols-5 gap-2 opacity-100 lg:opacity-0 group-hover:opacity-100 transition duration-300 relative z-20">
                    <button class="col-span-4 bg-primary text-white py-2 rounded text-[11px] md:text-sm font-bold hover:bg-blue-800 transition" onclick="event.stopPropagation(); addToCartAjax(<?= $p['id'] ?>);">Mua ngay</button>
